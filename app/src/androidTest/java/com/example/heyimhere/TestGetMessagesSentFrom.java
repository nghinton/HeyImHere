...
public class TestGetMessagesSentFrom {
    ...
    Contact contact = new Contact("contactName", "1234567890");
    ...
    public void getMessages() throws InterruptedException {
        ...
        databaseWriteExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i=1; i<5; i++) {
                    Message newMessage = new Message("message contents", contact.number, contact.number, true, "11111");
                    newMessage.id = i;
                    newMessage.body = "message contents " + i;
                    newMessage.isSent = true;
                    newMessage.receiver = contact.number;
        ...
        messageList = messageDao.getMessagesSentFrom(contact.number);
